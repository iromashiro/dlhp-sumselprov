    ...
    <div class="card-wrapper">
        ...
        <div class="card">
            ...
            <div class="card-header">
                <h3 class="mb-0">Input Main Menu</h3>
            </div>
            <!-- Card body -->
            <div class="card-body">
                <form method="POST" action="{{ route('store.main-menu') }}" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="form-group">
                            <div class="input-group input-group-merge">
                                <select name="status_menu" class="form-control">
                                    <option value="tidak ada">Tidak ada submenu</option>
                                    <option value="ada">Ada Submenu</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <button type="submit" class="btn btn-primary btn-lg btn-block">Input layanan</button>
                </form>
            </div>
        </div>
    </div>
