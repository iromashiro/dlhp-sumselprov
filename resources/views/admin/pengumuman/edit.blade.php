...
<script>
    tinymce.init({
        ...
        , image_class_list: [{
            title: 'fluid'
            , value: 'img-raised rounded img-fluid'
        }]
...
<div class="col-lg-12">
    <div class="card-wrapper">
        ...
        <div class="card">
            ...
            <!-- Card body -->
            <div class="card-body">
                <form method="POST" action="{{ route('pengumuman.update', $b->id) }}" enctype="multipart/form-data">
                    @method('patch')
                    @csrf
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <div class="input-group input-group-merge">
                                <input class="form-control" placeholder="Judul pengumuman" name="judul" type="text"
                        ...
                        <div class="form-group">
                            <div class="input-group input-group-merge">
                                <textarea id="description" name="isi_pengumuman" class="form-control"
                                    name="isi_menu">{{ $b->isi_pengumuman }}</textarea>
                            </div>
                        </div>
                    </div>
